...
const OTP = ({route}) => {
  ...
  useEffect(() => {
    if (timerInterval > 0) createInterval();
    return () => {};
  }, [timerInterval]);
    ...
    fetch(urls.verifyOTP, requestOptions)
      ...
      .then(async result => {
        if (result.status) {
          ...
          if (result.accessToken == null) setIsForm(true);
          else {
            ...
            <View style={styles.innerboxContainer}>
              ...
              <View style={styles.phoneNumber}>
                <View style={styles.numberInputView}>
                  ...
                  <View
                    style={{flex: 0.8, height: 40, justifyContent: 'center'}}>
                    <TextInput
                      editable={false}
                      value={phoneNumber}
                      style={{
              ...
              {isForm ? (
                ...
                <View style={styles.resendOtpView}>
                  <View style={styles.innerResendOtpView}>
                    ...
                    <View
                      style={{display: timerInterval > 0 ? 'flex' : 'none'}}>
                      <Text
                        style={{
                    ...
                    <View style={styles.innerUserName}>
                      <TextInput
                        ...
                        style={[
                          ...
                          {
                            borderWidth: 0.7,
                            borderColor: isError ? '#CA0B00' : '#fff',
                          },
                        ]}

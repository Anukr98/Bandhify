...
const Registration = () => {
  ...
  const onStarted = async direction => {
    if (direction === 'button') setIsLoading(true);
    ...
    <Modal
      ...
      <View style={styles.permissionDeniedContainer}>
        <View style={{width: '88%', alignSelf: 'center'}}>
          <View>
            <Text style={styles.headerText}>We understand your concerns!</Text>
          </View>
          <View style={{marginTop: '3%'}}>
            <Text style={styles.subText}>{strings.LOCATION_DISALLOWED}</Text>
          </View>
                ...
                <View style={styles.paraHeading}>
                  <View
                    style={[
                      ...
                      {
                        borderWidth: 0.8,
                        borderColor: isError ? '#CA0B00' : colors.WHITE,
                      },
                    ]}>

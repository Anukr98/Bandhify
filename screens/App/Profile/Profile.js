        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.profileInfo}>
            <TouchableOpacity
              ...
              activeOpacity={0.5}
              onPress={() =>
                userDetails.hasOwnProperty('birth_date') &&
          ...
          <View style={{flex: 1, marginBottom: 100}}>
            <Modal
              ...
              <View style={styles.modalContainer}>
                <View style={{marginBottom: '5%', marginTop: '3%'}}>
                  <Text style={styles.modalText}>{strings.CONFIRM_LOGOUT}</Text>
                </View>
            ...
            <View style={styles.itemRow}>
              <TouchableWithoutFeedback
                style={[styles.moreButton]}
                onPress={() => openLink(links.ABOUT_US)}>
                <View style={styles.innerButton}>
                  <View style={styles.buttonLeft}>
                    <View style={styles.buttonIcon}>
                      <Icon
            ...
            <View style={styles.itemRow}>
              <TouchableWithoutFeedback
                style={[styles.moreButton]}
                onPress={() => openLink(links.CONTACT_US)}>
                <View style={styles.innerButton}>
                  <View style={styles.buttonLeft}>
                    <View style={styles.buttonIcon}>
                      <Icon
            ...
            <View style={styles.itemRow}>
              <TouchableWithoutFeedback
                style={[styles.moreButton]}
                onPress={() => openLink(links.PRIVACY_POLICY)}>
                <View style={styles.innerButton}>
                  <View style={styles.buttonLeft}>
                    <View style={styles.buttonIcon}>
                      <Icon
                    ...
                    <View style={styles.buttonType}>
                      ...
                      <View
                        ...
                        <Text
                          style={
                            styles.buttonText
                          }>{`  ${userDetails?.referral_code?.coupon_code}`}</Text>
                      </View>
                    </View>
                  </View>
                </View>
